...
import contantImg from "../assets/img/contact-img.svg";
...
export const Contact = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if(result.code === 200){
            ...
            setStatus({ success: false, message: 'Algo salio mal, por favor intente mas tarde.' })
        }
    }
        ...
        <section className="contact" id="connect">
            <Container>
                <Row className="align-items-center">
                    <Col md={6}>
                        <img src={contantImg} alt="Contact Us"/>
                    </Col>
                    <Col md={6}>
                        <h2>Get In Touch</h2>
